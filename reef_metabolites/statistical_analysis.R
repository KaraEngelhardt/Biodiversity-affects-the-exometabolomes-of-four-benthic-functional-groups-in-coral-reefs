...
#________within species___________________
Cau <- subset(all_long, Species == "Caulerpa brachypus")
Pey <- subset(all_long, Species == "Peyssonnelia sp.")
Xen <- subset(all_long, Species == "Xenia umbellata")
Sin <- subset(all_long, Species == "Sclerophytum wanannense")
...
text_cau <-textGrob("C. brachypus", gp=gpar(fontsize=8.5, fontface="italic"), rot = 45, just = 1)
text_pey <-textGrob("Peyssonnelia sp.", gp=gpar(fontsize=8.5, fontface="italic"), rot = 45, just = 1)  
text_sin <-textGrob("S. wanannense", gp=gpar(fontsize=8.5, fontface="italic"), rot = 45, just = 1) 
text_xen <-textGrob("X. umbellata", gp=gpar(fontsize=8.5, fontface="italic"), rot = 45, just = 1) 
...
#ggsave("graphs/Fig5.png", width=11, height = 7, limitsize = FALSE, dpi = 700, treat_all)
...
text_cau <- textGrob("C. brachypus", gp=gpar(fontsize=8.5, fontface="italic"))
...
text_sin <- textGrob("S. wanannense", gp=gpar(fontsize=8.5, fontface="italic"))
text_xen <- textGrob("X. umbellata", gp=gpar(fontsize=8.5, fontface="italic"))
...
group3 <-textGrob("Cau, Mdi, Scl", gp=gpar(fontsize=7.5, fontface="plain", color = "lightgrey"), just = 1)
group4 <-textGrob("Hcn, Pey, Pve, Scl", gp=gpar(fontsize=7.5, fontface="plain", color = "lightgrey"), just = 1)
group5 <-textGrob("Cau, Hcn, Pey, Pve, Xen", gp=gpar(fontsize=7.5, fontface="plain", color = "lightgrey"), just = 1)
group6 <-textGrob("Hcn, Mdi, Pey, Pve, Scl", gp=gpar(fontsize=7.5, fontface="plain", color = "lightgrey"), just = 1)
group7 <-textGrob("Hcn, Mdi, Pey, Pve,
                  Slc, Xen", gp=gpar(fontsize=7.5, fontface="plain", color = "lightgrey"), just = 1)
...
#ggsave("graphs/Fig6.png", width=11, height = 7, limitsize = FALSE, dpi = 700, spec_all)
