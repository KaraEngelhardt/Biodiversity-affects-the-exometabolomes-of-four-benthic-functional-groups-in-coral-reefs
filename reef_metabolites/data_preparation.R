...
all <- all %>%
  mutate(Species = gsub("Cau", "Caulerpa brachypus",Species)) %>%
  ...
  mutate(Species = gsub("Xen", "Xenia umbellata", Species)) %>%
  mutate(Species = gsub("Sin", "Sclerophytum wanannense", Species)) %>%
...
all <- all%>%
  mutate(Organism_group = gsub("Xenia umbellata", "Soft coral", Organism_group)) %>%
  mutate(Organism_group = gsub("Sclerophytum wanannense", "Soft coral", Organism_group)) %>%
  mutate(Organism_group = gsub("Peyssonnelia sp.", "Macroalgae", Organism_group)) %>%
  mutate(Organism_group = gsub("Caulerpa brachypus", "Macroalgae", Organism_group)) %>%
